<?php
	...
	public function createOrUpdate($platformData, $id = null) {
		...
		if(!is_null($id)) {
			...
			$res ? $this->addMessage(self::MESSAGE_UPDATE_SUCCESS):$this->addError(self::MESSAGE_UPDATE_ERROR);
			//update
			return $id;
		} else{
			...
			$res ? $this->addMessage(self::MESSAGE_CREATE_SUCCESS):$this->addError(self::MESSAGE_CREATE_ERROR);
			return $res;
		}
	}
