...
<h4 class="mb-3">Case Analysis for past <?php Form::select('filter', [
	'60 days',
	'1 month',
	'6 month',
	'1 year',
...
<?php if(!empty($cases)):?>
	<h1>Total Cases : <?php echo count($cases)?></h1>
	<div class="row">
		<div class="col-md-4 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
...
<?php else:?>
	<h4>No cases found withing <?php echo $_GET['filter']?></h4>
<?php endif?>
<?php endbuild()?>
